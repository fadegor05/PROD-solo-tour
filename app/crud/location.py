...
async def create_location(session: AsyncSession, travel: Travel, city: str, country: str, lon: float, lat: float,
                          arrive_at: datetime.datetime, departure_at: datetime.datetime) -> Location:
